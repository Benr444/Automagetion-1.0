package com.baconianmethod.automagetion.crafting;
...
public class BasicCrafting 
{
	public static final void init()
	{
		...
		GameRegistry.addRecipe(new ItemStack(Blocks.fence_gate), new Object[] {"SWS", "SWS", 'W', ModBlocks.songwood, 'S', Items.stick});
